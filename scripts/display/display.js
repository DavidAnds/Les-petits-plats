...
function displayIngredients(recipes) {
    ...
    ingredientsArray.forEach(ingredient => {
        const ingredientModel = dropdownItemFactory(ingredient)
...
function displayAppliances(recipes) {
    ...
    appliancesArray.forEach(appliance => {
        const applianceModel = dropdownItemFactory(appliance)
...
function displayUstensils(recipes) {
    ...
    ustensilsArray.forEach(ustensil => {
        const ustensilModel = dropdownItemFactory(ustensil)
